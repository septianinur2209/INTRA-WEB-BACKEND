...
use App\Repositories\Setting\StatusLapanganRepository;
use Exception;

class StatusLapanganService
{
    protected StatusLapanganRepository $dataRepository;
    protected $filename;

    public function __construct(StatusLapanganRepository $dataRepository)
    {
        $this->dataRepository = $dataRepository;
        $this->filename = "StatusLapangan.xlsx";
    }
