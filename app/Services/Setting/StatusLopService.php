...
use App\Repositories\Setting\StatusLopRepository;
use Exception;

class StatusLopService
{
    protected StatusLopRepository $dataRepository;
    protected $filename;

    public function __construct(StatusLopRepository $dataRepository)
    {
        $this->dataRepository = $dataRepository;
        $this->filename = "StatusLOP.xlsx";
    }
