...
use App\Repositories\Master\MitraRepository;
use Exception;

class MitraService
{
    protected MitraRepository $dataRepository;
    protected $filename;

    public function __construct(MitraRepository $dataRepository)
    {
        $this->dataRepository = $dataRepository;
        $this->filename = "Mitra.xlsx";
    }
