...
use App\Repositories\Master\RegionalRepository;
use Exception;

class RegionalService
{
    protected RegionalRepository $dataRepository;
    protected $filename;

    public function __construct(RegionalRepository $dataRepository)
    {
        $this->dataRepository = $dataRepository;
        $this->filename = "Regional.xlsx";
    }
