...
use App\Repositories\Master\STORepository;
use Exception;

class STOService
{
    protected STORepository $dataRepository;
    protected $filename;

    public function __construct(STORepository $dataRepository)
    {
        $this->dataRepository = $dataRepository;
        $this->filename = "STO.xlsx";
    }
